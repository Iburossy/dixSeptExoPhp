...
<body>
<p><a href="EXO_14.php" class="a2 clignotant">Retour</a></p>
<h2 class="hh">Tous les prooduits ci-dessous sont a acheter</h2>
    <div class="product-container">
        <?php
        $products = [
            ["appart 1", "Appart 1 a acheter", 150000, "loge1.jpg"],
            ["appart 2", "Appart 2 a acheter", 120000, "loge2.jpg"],
            ["appart 3", "Appart 3 a acheter", 200000, "loge3.jpeg"],
            ["house 1", "Maison a acheter", 50000000, "loge4.jpeg"],
            ["house 2", "Maison a acheter", 60000000, "loge5.jpeg"],
            ["house 3", "Maison a acheter", 70000000, "loge6.jpeg"]
        ];
